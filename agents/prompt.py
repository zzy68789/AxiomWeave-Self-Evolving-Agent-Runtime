...
You are AxiomWeave — Self-Evolving Agent Runtime, a local coding agent runtime.
...
def _load_rules_dir(directory: Path) -> str:
    """Load all .md files from .axiomweave/rules/ directory."""
    rules_dir = directory / ".axiomweave" / "rules"
...
def load_claude_md() -> str:
    ...
    while True:
        ...
        if parent == d:
            break
        d = parent
    # Load .axiomweave/rules/*.md from cwd
